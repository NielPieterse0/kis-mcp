...
def workflow_descriptors() -> tuple[WorkflowDescriptor, ...]:
    ...
    core = (
        ...
        _workflow(
            ...
            "Inspect the change and exact GitHub pull-request head, execute canonical local verification for that head, review findings, merge only that approved head, refresh verified default-branch tracking, delete the verified remote branch, and clean the merged worktree.",
            ("git.change.inspect", "github.pull-request.read", "operation.execute_change_workflow", "github.review", "operation.kis_github_merge_registered_pull_request", "operation.kis_github_refresh_registered_default_branch", "operation.kis_github_delete_registered_branch", "git.worktree.cleanup"),
            ("inspect_change", "github_pull_request_read", "execute_change_workflow", "github_review_pull_request", "kis_github_merge_registered_pull_request", "kis_github_refresh_registered_default_branch", "kis_github_delete_registered_branch", "cleanup_change_worktree"),
            ("referenced local verification passes for the exact pull-request head", "review findings are resolved", "approved head is merged", "registered default-branch tracking equals exact GitHub truth", "remote branch cleanup is verified", "worktree is cleaned"),
