...
def test_provider_lifespan_keeps_one_client_connection_for_nested_proxy_calls() -> None:
...
def test_startup_call_runs_once_per_provider_runtime() -> None:
    async def scenario() -> None:
        client = FakeClient()
        provider = PersistentClientProxyProvider(
            client,
...
def test_startup_failure_closes_the_client() -> None:
