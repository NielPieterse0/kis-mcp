...
- [x] T-01 — Add provider client lifecycle tests and implementation.
- [x] T-02 — Add strict repository settings and selected-context source.
- [x] T-03 — Remove repository and Project bindings from GitHub provider authentication settings.
- [x] T-04 — Recompose GitHub with one runtime-scoped client and one `get_me` bootstrap.
