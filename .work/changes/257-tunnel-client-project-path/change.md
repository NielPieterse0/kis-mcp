...
- Keep broader Defender-safe runtime/tool acquisition under #541; do not treat relocation or copying alone as trust remediation.

## Implementation and verification

- Implementation notes: updated the canonical tunnel setting, `SPEC.md`, and the two tests that assert the configured path. Broader runtime/tool relocation was explicitly left to #541.
