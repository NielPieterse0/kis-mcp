# Tasks: Discover Serena Shared Client Lifecycle

- [x] Confirm authority and scope.
- [x] Reproduce the nested shared-client failure with a RED regression.
- [x] Implement the minimal context-depth lifecycle fix.
