...
- [x] Confirm authority and governed scope.
- [x] Reuse exact Discover source fingerprint authority.
- [x] Implement bounded deterministic Review Map projection.
- [x] Expose read-only `build_review_map` capability.
- [x] Add stale-source, ordering, bounds, truncation, and capability tests.
