# Tasks: Register Commodity Project

- [x] Confirm authority and scope.
- [x] Add the `commodity` central-registry binding.
- [x] Update all affected project/repository registry contract tests.
- [x] Run the focused registry tests: 10 passed.
