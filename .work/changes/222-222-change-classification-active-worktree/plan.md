# 222 Change Classification Active Worktree Implementation Plan

> **For agentic workers:** Execute this plan task-by-task and keep the declared scope current.

**Goal:** Resolve authoritative active governed worktree metadata for Work Management change classification while preserving landed historical behavior.
