# Tasks: Tools Foundation

- [x] Re-scope 029 to the generic Tools foundation only.
- [x] Remove generic Tools ownership from 035 and record its dependency on 029.
- [x] Implement and test immutable Tool contracts and deterministic registry.
