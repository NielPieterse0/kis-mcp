# Tasks: Runtime Authority Defender Conformance

- [x] Confirm authority, #541 kis-mcp scope, and exclusions.
- [x] Load `develop-code` and `develop-docs`.
- [x] Inventory current Python/uv/Node/Serena/native runtime chain.
- [x] Implement runtime authority and no-managed-Python construction.
