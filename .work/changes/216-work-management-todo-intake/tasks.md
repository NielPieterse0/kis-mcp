# Tasks: Work Management Todo Intake

- [x] Confirm authority and scope.
- [x] Add provider `Todo` intake regression coverage.
- [x] Implement configured intake alias normalization.
...
- [ ] Reconcile #415, close source issue, refresh `main`, and clean Change 216.
