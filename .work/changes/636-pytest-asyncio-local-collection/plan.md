# Pytest Asyncio Local Collection Implementation Plan

> **For agentic workers:** Execute this plan task-by-task and keep the declared scope current.

**Goal:** Restore deterministic supported local pytest collection by pinning a compatible pytest-asyncio plugin with pytest<9 and verifying the canonical dependency set before collection.
