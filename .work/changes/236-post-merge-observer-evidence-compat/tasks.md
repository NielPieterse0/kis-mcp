...
- [ ] Exact-head canonical GitHub Actions and Work merge-readiness pass.
- [ ] Merge approved head and reconcile canonical documentation ownership.
- [ ] Supervised `kis-op` refresh and live observer acceptance pass.
