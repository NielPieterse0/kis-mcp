...
- Closed `021-governance-claim-reconciliation` before merge so this PR does not create a new stale governance claim.
...
- Repository-wide `change-workflow.ps1 validate`: `{"active_changes": 3}`.
